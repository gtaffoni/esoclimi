...
gg         = 0 #geography
fo_const   = 0.7 #ocean fraction (only for gg=0)
p_CO2_P    = 38000 #CO2 partial pressure IN PPVM
TOAalbfile = 'CCM_RH60/ALB_g1_rh60_co2x100.txt' #chech that these are consistent with p_CO2_P
OLRfile    = 'CCM_RH60/OLR_g1_rh60_co2x100.txt'

# Directories and Files
template_dir="/data/murante/EsoClimi/VaryCO2/CodeEBM-Feb09-EarthGeo-CO2x100-VaryOceanF07/Templates/"
workDir = os.getcwd()

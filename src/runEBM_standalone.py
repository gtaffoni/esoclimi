...
planet=sys.argv[1] # read name of planet parameters file (e.g. EARTH.py)
planet=planet[:-3]
...
print 'reading %s parameters' % planet  
...
tf=open('startpar.h','r') # input template file
pf=open('parEBM.h','w')        # output parameter file
